                ...
                <div class="  w-[100%] mt-10">
                    <div
                        ...
                        <input type="email" placeholder="Search Something..."
                            class="w-full outline-none bg-white text-gray-600 text-sm px-4 py-4 " />
                        <button type='button'
                    ...
                    <div class="w-[70%] flex gap-3 mt-5   ">
                        <div class="mb-2 w-[36%]">
                            <select name="type"
                                class=" px-4 py-3 w-full border text-gray-600  rounded focus:outline-none border-blue-500" required>
                        ...
                        <div class="mb-2 w-[36%] ">
                            <select name="type"
                                class="px-4 py-3 border w-full text-gray-600 rounded focus:outline-none border-blue-600 " required>
                                <option value="">Select type</option>
                                <option value="">Select Category</option>
                                <option value="">Select Category</option>
                            </select>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-16 gap-x-8 mt-8">
                    <div class="bg-white cursor-pointer border-b-2 border-blue-500 overflow-hidden group">
                        <div class="relative overflow-hidden">
                            <img src="https://postbac.ma/wp-content/uploads/2020/09/DUT_FMD_Rabat.png" alt="Blog Post 1"
