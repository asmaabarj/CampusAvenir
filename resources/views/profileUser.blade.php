...
<body>
    ...
    <section class="xl:w-[90%] mt-32 mb-8 lg:ml-auto   mx-auto mx-6  gap-8 rounded-md ">
        <div class="flex gap-10">
            <form action="" method="" enctype="multipart/form-data"
                class="py-4 px-6 bg-white shadow-md rounded grid w-[65%] grid-cols-1 xl:grid-cols-2 gap-3">
                <div>
            ...
            <div class="bg-white rounded-md border w-[35%] flex flex-col items-center overflow-hidden">
                <div class="bg-blue-400 w-full h-24"></div>
        ...
        <div class="flex gap-10 mt-10  ">
            <form action="" method="" enctype="multipart/form-data"
                class="py-4 px-10 bg-white shadow-md rounded w-[65%]  grid grid-cols-1 gap-4">
                <div>
            ...
            <div class="bg-white flex justify-center w-[35%] items-center border-gray-200 border-[1px] py-5 rounded">
                <div
