<header class='shadow-sm py-3 px-4 z-50 fixed top-0 right-0 left-0  sm:px-10 bg-white w-full font-[sans-serif] min-h-[60px]'>
    <div class='flex flex-wrap items-center justify-between lg:gap-y-4 gap-y-6 gap-x-4'>
        ...
        <ul
            ...
            <li
                class='max-lg:border-b mt-2 lg:after:bg-black lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block  lg:after:transition-all lg:after:duration-300'>
                <a href='/managePosts' class='text-gray-700 block text-[15px]'>Publications</a>
            </li>
            <li
                class='max-lg:border-b mt-2 lg:after:bg-black lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block  lg:after:transition-all lg:after:duration-300'>
...
<nav id="sideBar"
    ...
    <ul>
        <li>
            <a href="/dashboard"
                class="text-blue-600 font-meduim text-sm flex items-center bg-white shadow-md rounded px-4 py-3 transition-all">
    ...
    <div class="mt-6">
        <h6 class="text-blue-600 text-sm font-bold px-4">Les domaines</h6>
        <ul class="mt-3">
            <li>
                <a href="/addDomaine"
                    ...
                    <span>Nouvel domaine</span>
                </a>
            </li>
            <li>
                <a href="/manageDomaine"
                    class="text-black hover:text-blue-600 hover:shadow-sm text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-[18px] h-[18px] mr-4"
