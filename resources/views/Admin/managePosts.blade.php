...
<body class="bg-[#F7F8FA]">
    ...
    <div class="font-[sans-serif] text-[#333] xl:ml-auto xl:w-[82%]">
        <div class="max-w-5xl mx-auto pb-8">
            <div class="grid lg:grid-cols-2 md:grid-cols-1  xl:mx-0 md:mx-8 gap-x-8 gap-y-10  max-md:justify-center mt-12">
                        ...
                        <div class="pr-6 text-right  py-4">
                            <div class="relative  group ">
                                ...
                                <div
                                    ...
                                    <form action="/posts/accept/{{ $poste->id }}" method="POST">
                                        @csrf
                                        <button type="submit" class="text-sm text-gray-500 hover:text-black">
                                            Accepter
                                        </button>
                                    </form>
                ...
                <div id="deleteModal{{ $poste->id }}"
                    ...
                    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                        <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                            ...
                            <p class="mb-4 text-gray-500 dark:text-gray-300">Êtes-vous sûr de vouloir Refuser cette
                                publication de publier</p>
