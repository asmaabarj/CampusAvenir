...
<body class="bg-[#F7F8FA]">
    ...
    <div class="font-[sans-serif] text-[#333] xl:ml-auto xl:w-[82%]">
        <div class="max-w-5xl mx-auto">    
          <div class="grid lg:grid-cols-2 md:grid-cols-2 gap-x-8 gap-y-10 max-md:justify-center mt-12">
            <div class="border rounded-md overflow-hidden max-md:max-w-[300px]">
              <img src="https://readymadeui.com/team-4.webp" class="w-full h-60 object-contain object-top bg-gray-300" />
              <div class="p-4">
                <h4 class="text-base font-extrabold">Sophia</h4>
                <p class="text-xs mt-1">Software Developer</p>
                <div class="mt-4">
                  <p class="text-sm leading-relaxed">Eiusmod commodo aliquip laboris qui anim non voluptate consectetur.</p>
                </div>
            ...
            <div class="border rounded-md overflow-hidden max-md:max-w-[300px]">
              <img src="https://readymadeui.com/team-5.webp" class="w-full h-60 object-contain object-top bg-gray-300" />
              <div class="p-4">
            ...
            <div class="border rounded-md overflow-hidden max-md:max-w-[300px]">
              <img src="https://readymadeui.com/team-6.webp" class="w-full h-60 object-contain object-top bg-gray-300" />
              <div class="p-4">
