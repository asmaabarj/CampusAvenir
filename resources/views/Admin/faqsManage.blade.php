                ...
                <table class="w-full text-sm text-left  text-gray-500 ">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b hover:bg-gray-50 ">
                            <td class="px-4 text-left py-4">{{$faq->question}}
                            </td>
                            <td class="px-4 text-left py-4">{{$faq->reponse}}
                            </td>
                        ...
                        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                            <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                <button onclick="toggleModal('deleteModal{{ $faq->id }}')" type="button"
                                ...
                                <div class="flex justify-center items-center space-x-4">
                                    <button onclick="toggleModal('deleteModal{{ $faq->id }}')" data-modal-toggle="deleteModal{{ $faq->id }}" type="button"
