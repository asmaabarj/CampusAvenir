...
<body class="bg-[#F7F8FA]">
    ...
    <div class="xl:w-[69%] xl:ml-auto xl:mr-24 mx-2 shadow-md mb-10 auverflow-auto">
                        ...
                        @foreach ($domaines as $domaine)
                            <tr class="bg-white border-b hover:bg-gray-50 ">
                                <th class="items-center px-6 py-4 text-gray-900 whitespace-nowrap ">
                                    <img class="w-11 h-11 rounded" src="{{ asset('storage/' . $domaine->photo) }}">
                                </th>
                            ...
                            <div id="deleteModal{{ $domaine->id }}"
                                ...
                                <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                    <div
                                        ...
                                        <button onclick="toggleModal('deleteModal{{ $domaine->id }}')" type="button"
                                            class="text-gray-400 absolute top-2.5 right-2.5 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                            data-modal-toggle="deleteModal{{ $domaine->id }}">
                                        ...
                                        <div class="flex justify-center items-center space-x-4">
                                            <button onclick="toggleModal('deleteModal{{ $domaine->id }}')" data-modal-toggle="deleteModal{{ $domaine->id }}"
                                                type="button"
