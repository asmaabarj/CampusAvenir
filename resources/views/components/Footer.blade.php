<footer class="bg-blue-100 py-12 px-12 font-[sans-serif]">
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-10">
        <div class="xl:col-span-2">
            <h1
                class="bg-gradient-to-r from-[#69A8F3] via-[#5102F8] font-extrabold text-3xl to-indigo-400 inline-block text-transparent bg-clip-text">
                CampusAvenir</h1>
            <p class="text-sm mt-6 max-w-2xl text-gray-500">Vous rêvez d'un avenir meilleur ? Nous pouvons vous aider à
                atteindre vos objectifs éducatifs et à libérer votre potentiel. CampusAvenir propose une variété de
                programmes adaptés à vos besoins et à vos intérêts. Contactez-nous dès aujourd'hui pour en savoir plus !
            </p>
    ...
    <div class="text-center">
        <p class='text-sm text-gray-500'>Copyright © {{ now()->year }}<a href='/'
                class="hover:underline mx-1">CampusAvenir</a>All
            Rights Reserved.</p>
    </div>
</footer>
