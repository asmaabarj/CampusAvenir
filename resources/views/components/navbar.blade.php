    ...
    <ul class='lg:!flex max-lg:hidden max-lg:w-full lg:space-x-10 max-lg:space-y-4 max-lg:my-4'>
        ...
        <li class='group max-lg:border-b max-lg:py-2 relative'>
            ...
            <ul
                ...
                <li class='border-b py-2 '><a href='javascript:void(0)'
                        class='hover:text-[#007bff] text-gray-600 text-[15px] font-bold block'>ingenieurie</a>
                </li>
                <li class='border-b py-2 '><a href='javascript:void(0)'
        ...
        <li class='group max-lg:border-b max-lg:py-2 relative'>
            ...
            <ul
                class='absolute hidden group-hover:block shadow-lg bg-white px-6 pb-4 pt-6 space-y-3 lg:top-5 max-lg:top-8 -left-6 min-w-[200px]'>
                <li class='border-b py-2 '><a href='javascript:void(0)'
                        class='hover:text-[#007bff] text-gray-600 text-[15px] font-bold block'>Etudier au public</a>
                </li>
                <li class='border-b py-2 '><a href='javascript:void(0)'
                        class='hover:text-[#007bff] text-gray-600 text-[15px] font-bold block'>Etudier au privé</a></li>
            </ul>
        </li>
        <li class='max-lg:border-b max-lg:py-2'><a href='/'
